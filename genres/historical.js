...
// Historicalbtn.addEventListener('click', async (e) => {
...
async function fetchHistorical() {
    const url = "https://openlibrary.org/subjects/historical_fiction.json?limit=50"
...
function displayHistorical(historicalBooks) {
    ...
    for (let book of historicalBooks) {
        let isSaved = false
        ...
        card.innerHTML = `
            ...
            `
        historicalbooksContainer.appendChild(card)
